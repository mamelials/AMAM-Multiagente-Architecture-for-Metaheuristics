...
public class VRPBestNeighborCompleteDescent implements BestNeighbor{
	...
	public Solution bestNeighbor(int neighborhood, MoveNeighborhood movement_neighborhood, 
		...
		switch (movement_neighborhood.getList().getMoveI(k).getMoveType()) {
			...
			case "shift_inter":
				this.bestNeighborNShiftInter(k, movement_neighborhood, criteria, parameters, e, p);
				break;
			case "shift_intra":
				this.bestNeighborShiftIntra(k, movement_neighborhood, criteria, parameters, e, p);
				break;
			case "swap_inter":
				this.bestNeighborNSwapInter(k, movement_neighborhood, criteria, parameters, e, p);
				break;
			case "swap_intra":
	...
	public void bestNeighborNShiftInter(int neighborhood, MoveNeighborhood movement_neighborhood,
	...
	public void bestNeighborNSwapInter(int neighborhood, MoveNeighborhood movement_neighborhood,
			AcceptationCriteria criteria, Parameters parameters, Element e, Problem p) {
