...
public class MovementVRPEliminatesRandomRoute extends Movement{

	public MovementVRPEliminatesRandomRoute(String move_type) {
		super(move_type);
	...
	public Solution movement(Solution s, int receiver_size, Element element,
		...
		vrp_element.setValid(sol.eliminatesRandomRoute(vrp, receiver_size));
