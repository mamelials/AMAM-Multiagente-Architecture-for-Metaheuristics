...
public class MovementVRPTwoShiftInter extends Movement{

	public MovementVRPTwoShiftInter(String move_type) {
		super(move_type);
	...
	public Solution movement(Solution s, int receiver_size, Element element,
		...
		vrp_element.setValid(sol.nShiftInter(2,vrp_element.getRoute1(), vrp_element.getPositionClient1(), vrp_element.getRoute2(), vrp_element.getPositionClient2(), vrp));
