...
public class MovementVRPSwapIntra extends Movement{

	
	public MovementVRPSwapIntra(String move_type) {
		super(move_type);
	...
	public Solution movement(Solution s, int receiver_size, Element element, Problem p) {
		...
		vrp_element.setValid(sol.swapIntra(vrp_element.getRoute1(), vrp_element.getPositionClient1(), vrp_element.getPositionClient2(), vrp));
