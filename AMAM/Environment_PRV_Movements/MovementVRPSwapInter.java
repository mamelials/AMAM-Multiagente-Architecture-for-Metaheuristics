...
public class MovementVRPSwapInter extends Movement{

	public MovementVRPSwapInter(String move_type) {
		super(move_type);
	...
	public Solution movement(Solution s, int receiver_size, Element element, Problem p) {
		...
		vrp_element.setValid(sol.nSwapInter(1, vrp_element.getRoute1(), vrp_element.getPositionClient1(), vrp_element.getRoute2(), vrp_element.getPositionClient2(), vrp));
