...
public class MovementPMSwapInter extends Movement{

	public MovementPMSwapInter(String move_type) {
		super(move_type);
	...
	public Solution movement(Solution s, int receiver_size, Element element, Problem p) {
		...
		pm_element.setValid(sol.swapPMInter(pm_element.getPositionTask1(), pm_element.getMachine1(), pm_element.getPositionTask2(), pm_element.getMachine2(), pm));
