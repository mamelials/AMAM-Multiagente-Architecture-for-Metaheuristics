...
public class MovementPMSwapIntra extends Movement {

	public MovementPMSwapIntra(String move_type) {
		super(move_type);
	...
	public Solution movement(Solution s, int receiver_size, Element element, Problem p) {
		...
		pm_element.setValid(sol.swapPMIntra(pm_element.getPositionTask1(), pm_element.getMachine1(), pm_element.getPositionTask2(), pm));
